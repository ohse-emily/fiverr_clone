...
clearbit.initialize({"Clearbit":{"apiKey": "pk_8948d19a5f8dfc3fb7848b227ac34dd2"}});
while (clearbitsq && clearbitsq.length > 0) {
  ...
  var properties = [{"id":"UA-12078752-17","name":"fiverr__new","mapping":{"dimension24":"5K-10K"}}];
  ...
  function trackClearbitMappings() {
    ...
    if (pushToDataLayer) {
      ...
      var response = {"ip":"115.94.144.100","domain":"kakaocorp.com","fuzzy":true,"type":"company","geoIP":{"city":"Goyang-si","state":"Gyeonggi-do","stateCode":null,"country":"Republic of Korea","countryCode":"KR"},"company":{"id":"adef445c-3af5-4926-8bec-98884bb02d3e","geo":{"lat":33.4507389,"lng":126.5707934,"city":"Cheju","state":"Jeju-do","country":"Korea, Republic of","stateCode":null,"postalCode":"690-140","streetName":null,"subPremise":null,"countryCode":"KR","streetNumber":null},"logo":"https://logo.clearbit.com/kakaocorp.com","name":"Kakao","site":{"phoneNumbers":[],"emailAddresses":["hotline@kakaocorp.com","careers@kakaocorp.com","Kakao_IBS_Office_WS_team_GA_property_part@kakaocorp.com"]},"tags":["Internet","Technology","Information Technology & Services","B2B","Mobile","B2C","ISP"],"tech":["google_apps","java","sap_hana","matomo","oracle_data_integrator","db2","apache_tomcat","atlassian_jira","hbase","rabbitmq","splunk","aws_dynamodb","github","hootsuite","qlikview","neo4j","sap_crm","apache_cassandra","apache_spark","oracle_peoplesoft","mongodb","couchbase","ibm_websphere","hive","apache_hadoop","sap_business_objects","salesforce","postgresql","cloudera","mysql","oracle_hyperion"],"type":"public","phone":null,"domain":"kakaocorp.com","parent":{"domain":null},"ticker":null,"metrics":{"raised":null,"employees":8602,"marketCap":null,"alexaUsRank":null,"annualRevenue":null,"employeesRange":"5K-10K","fiscalYearEnd":null,"alexaGlobalRank":11933,"estimatedAnnualRevenue":null},"profane":false,"twitter":{"id":null,"bio":null,"site":null,"avatar":null,"handle":null,"location":null,"followers":null,"following":null},"category":{"sector":"Information Technology","industry":"Internet Software & Services","sicCode":"87","naicsCode":"54","subIndustry":"Internet","industryGroup":"Software & Services"},"facebook":{"likes":null,"handle":null},"internal":{"confidenceScore":67},"linkedin":{"handle":"company/kakaocorp"},"location":"242 Cheomdan-ro, Ara-dong, Cheju, Jeju-do, South Korea","canonical":true,"timeZone":"Asia/Seoul","crunchbase":{"handle":"organization/kakao"},"indexedAt":"2021-04-03 03:52:16 UTC","legalName":"Kakao Corp.","utcOffset":9,"description":"Kakao is a South Korean Internet company that was established in 2010.","identifiers":{"usEin":null},"foundedYear":2010,"domainAliases":["daumcorp.com","kakao.com","daumkakao.com","kakaocorp.co.kr","kakao.co.kr","kakaotalk.com","kakaotalk.co.id","kakaocdn.net"],"emailProvider":false,"techCategories":["productivity","programming_framework","database","analytics","data_management","web_servers","project_management_software","data_processing","marketing_automation","crm","business_management"],"ultimateParent":{"domain":null}}};
